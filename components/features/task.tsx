...
import { Task, useTaskStore } from '@/lib/store/task'
import { cn } from '@/lib/utils'

export default function Task({ id, title, description, status }: Task) {
  ...
  return (
    ...
    >
      ...
      <button className="cursor-pointer" onClick={() => remove(id)}>
        <svg
